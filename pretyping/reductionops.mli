...
val splay_prod : env ->  evar_map -> constr -> (Name.t * Sorts.relevance * constr) list * constr
val splay_lam : env ->  evar_map -> constr -> (Name.t * Sorts.relevance * constr) list * constr
val splay_arity : env ->  evar_map -> constr -> (Name.t * Sorts.relevance * constr) list * ESorts.t
