...
and eqappr univ cv_pb infos relevances (lft1,st1) (lft2,st2) =
  ...
  match (fterm_of hd1, fterm_of hd2) with
    ...
    | (FLambda _, FLambda _) ->
        ...
        ccnv univ CONV infos (r1::relevances) (el_lift el1) (el_lift el2) bd1 bd2

    | (FProd (_,r1,c1,c2), FProd (_,_,c'1,c'2)) ->
        assert (is_empty_stack v1 && is_empty_stack v2);
	(* Luo's system *)
        ccnv univ CONV infos relevances el1 el2 c1 c'1;
        ccnv univ cv_pb infos (r1::relevances) (el_lift el1) (el_lift el2) c2 c'2
	...
	with Not_found -> raise NotConvertible)
     ...
     | (FFix ((op1,(_,r1,tys1,cl1)),e1), FFix((op2,(_,_,tys2,cl2)),e2)) ->
	 if op1 = op2
	 then
	   let n = Array.length cl1 in
           ...
           (let relevances = List.append (Array.rev_to_list r1) relevances in
