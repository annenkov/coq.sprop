...
and eqappr cv_pb l2r infos relevances (lft1,st1) (lft2,st2) cuniv =
  ...
  match (fterm_of hd1, fterm_of hd2) with
    ...
    | (FLambda _, FLambda _) ->
        ...
        ccnv CONV l2r infos (r1::relevances) (el_lift el1) (el_lift el2) bd1 bd2 cuniv
	...
	(* Luo's system *)
        ...
        ccnv cv_pb l2r infos (r1::relevances) (el_lift el1) (el_lift el2) c2 c'2 cuniv
    ...
    | (FLambda _, _) ->
        ...
        in
        let (_,r1,ty1,bd1) = destFLambda mk_clos hd1 in
        let relevances = r1 :: relevances in
	...
	in
        ...
        let relevances = r2 :: relevances in
        eqappr CONV l2r infos relevances
	  ...
	  let n = Array.length cl1 in
          ...
          let cuniv =
            let relevances = Array.fold_left
                (fun relevances r -> r::relevances) relevances r1
            in
