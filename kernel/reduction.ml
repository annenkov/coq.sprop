...
let rec ccnv cv_pb l2r infos lft1 lft2 term1 term2 cuniv =
  ...
  let relevances = info_relevances infos in
...
and eqappr cv_pb l2r infos (lft1,st1) (lft2,st2) cuniv =
  ...
  match (fterm_of hd1, fterm_of hd2) with
    ...
    | (FLambda _, FLambda _) ->
        ...
        ccnv CONV l2r (push_relevance infos r1) (el_lift el1) (el_lift el2) bd1 bd2 cuniv
	...
	(* Luo's system *)
        ...
        ccnv cv_pb l2r (push_relevance infos r1) (el_lift el1) (el_lift el2) c2 c'2 cuniv
    ...
    | (FLambda _, _) ->
        ...
        in
        let (_,r1,ty1,bd1) = destFLambda mk_clos hd1 in
        let infos = push_relevance infos r1 in
	...
	in
        ...
        let infos = push_relevance infos r2 in
        eqappr CONV l2r infos
	...
	then
	  let n = Array.length cl1 in
          ...
          let cuniv =
            let infos = Array.fold_left
                (fun infos r -> push_relevance infos r) infos r1
            in
...
let () = CClosure.set_conv (fun infos a b ->
    try
