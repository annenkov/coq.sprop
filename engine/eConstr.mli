...
val mkProd : Name.t * Sorts.relevance * t * t -> t
val mkLambda : Name.t * Sorts.relevance * t * t -> t
val mkLetIn : Name.t * Sorts.relevance * t * t * t -> t
...
val destProd : Evd.evar_map -> t -> Name.t * Sorts.relevance * types * types
val destLambda : Evd.evar_map -> t -> Name.t * Sorts.relevance * types * t
val destLetIn : Evd.evar_map -> t -> Name.t * Sorts.relevance * t * types * t
...
val decompose_lam : Evd.evar_map -> t -> (Name.t * Sorts.relevance * t) list * t
...
val compose_lam : (Name.t * Sorts.relevance * t) list -> t -> t
val to_lambda : Evd.evar_map -> int -> t -> t

val decompose_prod : Evd.evar_map -> t -> (Name.t * Sorts.relevance * t) list * t
