...
val mkProd_name : env -> evar_map -> Name.t * Sorts.relevance * types * types -> types
val mkLambda_name : env -> evar_map -> Name.t * Sorts.relevance * types * constr -> constr

(** Deprecated synonyms of [mkProd_name] and [mkLambda_name] *)
val prod_name : env -> evar_map -> Name.t * Sorts.relevance * types * types -> types
val lambda_name : env -> evar_map -> Name.t * Sorts.relevance * types * constr -> constr
